...
![Страница входа](media/screenshots/login.png)

### Чат

![Главный экран чата](media/screenshots/chat.png)

### Гипотеза

![Карточка гипотезы](media/screenshots/hypothesis.png)

### Граф знаний

![Визуализация графа знаний](media/screenshots/graph.png)
